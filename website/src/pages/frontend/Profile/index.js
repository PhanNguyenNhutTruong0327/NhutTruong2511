                            ...
                            <article class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <figure class="icontext">
                                        <div class="d-flex">
                                            <div class="icon-avt ">
                                                <img class="rounded-circle img-sm border" src={require("../../../assets/images/avata/avt-1.jpg")} width="100px" height="100px" />
                                            </div>
                                            <div class="text ms-3">
                                                <strong> Nhựt Trường </strong>
                                                <p class="mb-2"> ahihi@gmail.com  </p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <figure class="itemside  mb-3">
                                                <div class="aside d-flex flex-row"><img src={require("../../../assets/images/products/banh-bong-lan-cha-bong.jpg")} width="100px" height="100px" class="border img-sm" /></div>
                                        ...
                                        <div class="col-md-6">
                                            <figure class="itemside  mb-3">
                                                <div class="aside"><img src={require("../../../assets/images/products/banh-donut.jpg")} class="border img-sm" width="100px" height="100px" /></div>
                                                <figcaption class="info">
                                                    <time class="text-muted" style={{ fontSize: "15px" }}><i class="fa fa-calendar-alt"></i> 12.09.2019</time>
                                        ...
                                        <div class="col-md-6">
                                            <figure class="itemside mb-3">
                                                <div class="aside"><img src={require("../../../assets/images/products/banh-my-croissant-socola.jpg")} width="100px" height="100px" class="border img-sm" /></div>
                                                <figcaption class="info">
                                                    <time class="text-muted" style={{ fontSize: "15px" }}><i class="fa fa-calendar-alt"></i> 12.09.2019</time>
